...
namespace EntitySystem
{
    ...
    public abstract class Entity : MonoBehaviour//Don't use Unity Callback functions in this class, use them in its children.
    {
    ...
    */
    public class Hit
    {
        ...
        public Hit(ScalableStat[] damage, Entity origin, Entity target)
        {
